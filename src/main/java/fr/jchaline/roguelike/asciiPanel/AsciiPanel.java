package fr.jchaline.roguelike.asciiPanel;
...
public class AsciiPanel extends JPanel {
	 ...
	 * @param height
	 * @param font
	 *            if passing null, standard font CP437_9x16 will be used
	 */
	 ...
	 * the default foreground and background colors are. The cursor position
